...
public class UtilisateurService
{
	...
	// PARTIE MISE A JOUR DE LA COTISATION D'UN UTILISATEUR

	@DbWrite
	public void saveCotisation(final CotisationDTO dto)
	{
		EntityManager em = TransactionHelper.getEm();
		
		for (UtilisateurDTO uDto : dto.utilisateurs)
		{
			Utilisateur u = em.find(Utilisateur.class, uDto.id);
			u.setCotisation(uDto.cotisation);
		}
	}
